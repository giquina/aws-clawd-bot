      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-green-600">Groq Savings</p>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-xl font-semibold">{stats.groq.requests}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Tokens</p>
                <p className="text-xl font-semibold">{(stats.groq.tokens / 1000).toFixed(0)}K</p>
              </div>
            </div>

            <div>
              <p className="text-sm text-gray-500 mb-2">Model Breakdown</p>
        ...
        <Card className="border-purple-200">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-gray-500">Requests</p>
                <p className="text-xl font-semibold">{stats.claude.requests}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Tokens</p>
                <p className="text-xl font-semibold">{(stats.claude.tokens / 1000).toFixed(0)}K</p>
              </div>
            </div>
            ...
            <div className="pt-2 border-t">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-500">Cost</span>
                <span className="text-lg font-bold text-purple-600">${stats.claude.cost.toFixed(2)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-blue-200">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-gray-500">Requests</p>
                <p className="text-xl font-semibold">{stats.grok.requests}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Tokens</p>
                <p className="text-xl font-semibold">{(stats.grok.tokens / 1000).toFixed(0)}K</p>
              </div>
            </div>
            ...
            <div className="pt-2 border-t">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-500">Cost</span>
                <span className="text-lg font-bold text-blue-600">${stats.grok.cost.toFixed(2)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
